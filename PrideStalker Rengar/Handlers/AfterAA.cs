...
namespace PrideStalker_Rengar.Handlers
{
    class AfterAA : Core
    {
        public static void OnAction(object sender, OrbwalkingActionArgs e) // Shit code, makes me want to kms. Be aware.
        {
            if (Variables.Orbwalker.ActiveMode == OrbwalkingMode.LaneClear && e.Type == OrbwalkingType.AfterAttack)
            {
                ...
                if (MenuConfig.ComboMode.SelectedValue != "Ap Combo") return;
